...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(242, 222)
        icon = QIcon()
        icon.addFile(u":/icons/icons/ip.ico", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        self.label.setPixmap(QPixmap(u":/icons/icons/ip (1).png"))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"IPInfo", None))
        self.label.setText("")
